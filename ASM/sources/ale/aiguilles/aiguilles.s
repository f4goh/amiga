;-------------------------------------------------------------------
;-                 Un petit essai de DROITES: aiguilles            -
;-------------------------------------------------------------------
...
equa1
voix1		lea	mt_voice1+$12,a3
		cmp.w	#$0,(a3)
		bge	suite
		move.w	#$0,(a3)
suite		move.w	(a3),d2
		bsr	aiguille1		
voix2		subq.w	#vitessetourne,(a3)		;on decremente voix no 1...
		lea	mt_voice2+$12,a3
		cmp.w	#$0,(a3)
		bge	suite2
		move.w	#$0,(a3)
suite2		move.w	(a3),d2
		bsr	aiguille2
voix3		subq.w	#vitessetourne,(a3)		;on decremente voix no 2...
		lea	mt_voice3+$12,a3
		cmp.w	#$0,(a3)
		bge	suite3
		move.w	#$0,(a3)
suite3		move.w	(a3),d2
		bsr	aiguille3
voix4		subq.w	#vitessetourne,(a3)		;on decremente voix no 3...
		lea	mt_voice4+$12,a3
		cmp.w	#$0,(a3)
		bge	suite4
		move.w	#$0,(a3)
suite4		move.w	(a3),d2
		bsr	aiguille4
finvoix		subq.w	#vitessetourne,(a3)		;on decremente voix no 4...
		rts
...
;	move.w	#$20,$9c(a6)		;a tester ok bernard
;	rte
lev3save:
	jmp	$0
...
coul2		dc.w	$fff
		...
		dc.l	-2
;------------------------------------------------------------------------
aigudata:	incbin	aigu.b
mt_data		incbin	mod.reflex2
;------------------------------------------------------------------------
