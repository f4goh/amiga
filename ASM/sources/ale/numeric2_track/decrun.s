offset	= 219802	;taille module cruncher -2
	section	all,code_c
start:
	bsr	decrunch
	bsr	mt_init
...
;data decruncher
;-------------- crunched data
data:		incbin mod.doors
		even
mt_data:	dcb.b	(333378-offset),0
mt_data2 = mt_data-offset
