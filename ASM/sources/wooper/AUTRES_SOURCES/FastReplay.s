;mega routine de soundtrack 8 ligne
...
loop	cmp.b	#6,$dff006
	bne.s	loop
	move.w	#$fff,$dff180
	movem.l	d0-d3/a0-a7,-(sp)
	bsr	mt_music
	movem.l	(sp)+,d0-d3/a0-a7
	clr.w	$dff180
	btst	#6,$bfe001
	bne.s	loop
	bsr	mt_end
...
mt_sp3:
	move.b	d0,mt_speed-mt_playvoice(a6)
	rts
...
mt_oldirq:	dc.l	0
mt_data	incbin	"df0:modules/mod.sanity"
