;equalizer made par spectre on peut utiliser les equa en barres pour
;essai fichier equa
;
;label
execbase equ 4
...
equalizer:
	...
	lea	table,a1
	lea	imagequa,a3
	lea	mt_aud1temp,a0	;1er equalizer
	move.l	a3,a4
	move.w	18(a0),d0
	move.b	(a1,d0.w),d0
	and.l	#$ff,d0
	...
	clr	18(a0)
	bra	test11
test1:	subq.w	#2,18(a0)
test11:	lea	mt_aud2temp,a0	;2nd equalizer
	move.l	a3,a4
	add.l	#4,a2
	move.w	18(a0),d0
	move.b	(a1,d0.w),d0
	...
	clr	18(a0)
	bra	test22
test2:	subq.w	#2,18(a0)
test22:	lea	mt_aud3temp,a0	;3eme equalizer
	move.l	a3,a4
	add.l	#4,a2
	move.w	18(a0),d0
	move.b	(a1,d0.w),d0
	...
	clr	18(a0)
	bra	test33
test3:	subq.w	#2,18(a0)
test33:	lea	mt_aud4temp,a0	;4eme equalizer
	move.l	a3,a4
	add.l	#4,a2
	move.w	18(a0),d0
	move.b	(a1,d0.w),d0
	...
	clr	18(a0)
	rts
test4:	subq.w	#2,18(a0)
	rts
tequa:	bsr	wait_blitter
...
grname:dc.b "graphics.library",0
 even
copper:dc.w $e0,0,$e2,0,$ffff,$fffe
copperend:
table:	dc.b	0,0,0,0,2,2,2,2,4,4,4,4,6,6,6,6,8,8,8,8,10,10,10,10,12,12
	dc.b	12,12,14,14,14,14,16,16,16,16,18,18,18,18,20,20,20,20,22
	dc.b	22,22,22,24,24,24,24,26,26,26,26,28,28,28,28,30,30,30,30,30
save_dmacon:dc.w 0
equa1:	ds.w 1
equa2:	ds.w 1
equa3:	ds.w 1
equa4:	ds.w 1
bpladr:	ds.b 10240
mt_data:incbin "monalisa" ;the module
imagequa:incbin "equa"
